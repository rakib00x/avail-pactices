<?php
    ...
    $all_pending_oders = DB::table('order')
        ->join('express', 'order.supplier_id', '=', 'express.id')
        ...
        ->where('order.customer_id', Session::get('buyer_id'))
            ...
            <div class="navbar-container content">
                <div class="navbar-collapse" id="navbar-mobile">
                    ...
                    $total_receive_message = DB::table('tbl_quotation_reply')
                        ...
                        ->count() ;
                    $notification = DB::table('tbl_quotation_reply')
            ->join('express', 'tbl_quotation_reply.sender_id', '=', 'express.id')
            ->select('tbl_quotation_reply.*', 'express.first_name', 'express.last_name', 'express.email', 'express.type', 'express.storeName')
            ->where('tbl_quotation_reply.receiver_id', Session::get('buyer_id'))->where('tbl_quotation_reply.receiver_status', 0)->get() ;
            
                   
                ?>
                        <li class="dropdown dropdown-notification nav-item"><a class="nav-link nav-link-label" href="#" data-toggle="dropdown"><i class="ficon bx bx-bell bx-tada bx-flip-horizontal"></i><span class="badge badge-pill badge-danger badge-up"><?php echo $total_receive_message; ?></span></a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <div class="dropdown-header px-1 py-75 d-flex justify-content-between"><span class="notification-title"><?php echo $total_receive_message; ?> new Notification</span></div>
                                </li>
                                 ...
                                 <?php foreach ($all_pending_oders as $ordervalue): ?>
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <div class="media-body">
                                                <a href="{{ URL::to('buyerOrderDetails/'.$ordervalue->invoice_number) }}"><h6 class="media-heading"><span class="text-bold-500"><?php if($ordervalue->type == 2){echo $ordervalue->storeName; }else{echo $ordervalue->first_name." ".$ordervalue->last_name; } ?></span> </h6>
                            ...
                            <li class="dropdown-menu-footer"><a class="dropdown-item p-50 text-primary justify-content-center" href="{{URL::to('buyerQuotationlist')}}">Read all notifications</a></li>
                        </ul>
                    </li>
                    <li class="dropdown dropdown-user nav-item">
                            ...
                            <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo $buyer_info->first_name." ".$buyer_info->last_name ; ?></span><span class="user-status text-muted">Available</span></div><span>
                                <?php if($buyer_info->image != "" || $buyer_info->image != null){
                                    if(strpos($buyer_info->image, "https") !== false){
                                       ...
                                       $image_url ="public/images/buyerPic/".$buyer_info->image;
                                    }
                                }else{
                        ...
                        <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" href="{{ URL::to('buyerAccountSettings') }}"><i class="bx bx-user mr-50"></i> Edit Profile</a>
                        <a class="dropdown-item" href="{{URL::to('msBox')}}"><i class="bx bx-envelope mr-50"></i> Chats</a>
                        <!--<a class="dropdown-item" href="app-todo.html"><i class="bx bx-check-square mr-50"></i> Task</a>-->
                        <!--<a class="dropdown-item" href="{{URL::to('supplier-chat')}}"><i class="bx bx-message mr-50"></i> Chats</a>-->
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            <li class=" nav-item"><a href="{{ URL::to('buyerDashboard') }}"><i class="menu-livicon" data-icon="desktop"></i><span class="menu-title" data-i18n="Dashboard">Buyer Dashboard</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="location"></i><span class="menu-title" data-i18n="User">Address</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="shoppingcart"></i><span class="menu-title" data-i18n="User"> Order</span></a>
                <ul class="menu-content">
            ...
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="envelope-pull"></i><span class="menu-title" data-i18n="User"> Message</span><span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
                <?php 
                    ...
                    echo number_format($total_receive_message) ;
                ?>
            </span></a>
                <ul class="menu-content">
                    <li class=" nav-item"><a href="{{URL::to('/buyerQuotationlist')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Inbox <span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
                <?php echo $total_receive_message; ?></span></span></a>
                    </li>
                </ul>
            </li>
