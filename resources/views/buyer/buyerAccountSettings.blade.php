                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <img src="{{URL::to('/public/images/buyerPic/'.$values->image)}}" class="rounded mr-75" alt="profile image"  height="64" width="64">
                                                                <div class="controls">
                                                                    <label>Image</label>
...
<script>
    ...
    $("#updateinfo").submit(function(e){
        ...
        $.ajax({
            'url':"{{ url('/updateBuyerGeneralInfo') }}",
            'data': formData,
            'processData': false, 
            'contentType': false,
            'type': 'POST',
