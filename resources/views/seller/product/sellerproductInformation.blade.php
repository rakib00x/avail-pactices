...
<a class="list-group-item list-group-item-action" id="list-profile-list" data-toggle="list" href="#list-profile" role="tab">Images <span style="color: red!important;
    font-size: 15px;">*</span></a>
<a style="display:none;" class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab">Video </a>
...
<a class="list-group-item list-group-item-action" id="list-escription-list" data-toggle="list" href="#list-description" role="tab">Description <span style="color: red!important;
    font-size: 15px;">*</span></a>
<a style="display:none;" class="list-group-item list-group-item-action" id="list-Shipping-list" data-toggle="list" href="#list-Shipping" role="tab">Shipping & Payment Info</a>
        ...
        <div class="form form-horizontal">
            ...
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <label>Product Name <span style="color: red!important;font-size: 15px;">*</span></label>
                    </div>
                    <div class="col-md-9 form-group">
                    ...
                    <div class="col-md-3">
                        <label>Unit <span style="color: red!important;font-size: 15px;">*</span></label>
                    </div>
                    <div class="col-md-9 form-group">
...
<!-- Shipping Info Start -->
<div style="display:none;" class="tab-pane" id="list-Shipping" role="tabpanel" aria-labelledby="list-Shipping-list" >
    <div class="form form-horizontal">
        <div class="form-body">
            <div class="row">
                <div class="col-md-4">
                        ...
                        <div class="tab-pane" id="profile-fill" role="tabpanel" aria-labelledby="profile-tab-fill">
                            <form id="upload_image_siam" method="POST" enctype="multipart/form-data" >
                                ...
                                <label for="main_image" style="border: 1px solid red;width: 100%;padding: 57px;text-align:center">
                                    <input type="file" id="main_image" class="form-control" name="images[]"  multiple style="display:none">
                                    Select Images
                                </label>
