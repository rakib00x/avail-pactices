...
@section('title','Seller Orders List')
@section('content')
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="invoice-action">
                                                <a href="{{ URL::to('sellerinvoice/'.$value->invoice_number) }}" class="invoice-action-view mr-1">
                                                    <i class="bx bx-show-alt"></i>
                                                </a>
                                                <a href="{{ URL::to('editsellerinvoice/'.$value->invoice_number) }}" class="invoice-action-edit cursor-pointer">
