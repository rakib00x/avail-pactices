                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <div class="card-body pt-50">
                                    {!! Form::open(['url' =>'updatesellerinvoiceupdate','method' => 'post','role' => 'form', 'class' => 'form invoice-item-repeater', 'files'=>'true']) !!}
                                                            ...
                                                            <div class="invoice-item d-flex border rounded mb-1">
                                                                ...
                                                                <div class="invoice-icon d-flex flex-column justify-content-between border-left p-25">
                                                                    ...
                                                                    <span class="cursor-pointer" >
                                                                        <a href="{{ URL::to('deletesellerorderitem/'.$value->id) }}" title="" onclick="return confirm('Are you sure to remove this item');">
                                                                            <i class="bx bx-x"></i>
                                                                        </a>
                                                                    </span>
                                                                </div>
