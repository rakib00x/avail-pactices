...
<!--                                     <div class="row my-3">
                                    ...
                                    <div class="row invoice-info">
                                        ...
                                        <div class="col-6 mt-1">
                                            ...
                                            <div class="mb-1">
                                                <span>{{ $main_invoice_info->contact_name }}</span>
                                            </div>
                                            <div class="mb-1">
                                                <span>{{ $main_invoice_info->address }}, {{ $main_invoice_info->state_name }}, {{ $main_invoice_info->city_name }}, {{ $main_invoice_info->zip_code }}</span>
                                            </div>
                                            <div class="mb-1">
                                                <span>{{ $main_invoice_info->mobile_number }}</span>
                                            </div>
                                            <div class="mb-1">
                            ...
                            <div class="card-body">
                                @if($value->status == 0)
                                    <div class="invoice-action-btn">
                                        <a href="{{ URL::to('supplierOrderConfirm/'.$value->invoice_number) }}" class="btn btn-light-success btn-block" onclick="return confirm('Are you sure to Confirm It ??')">
                                ...
                                <div class="invoice-action-btn">
                                    <a href="{{ URL::to('editsellerinvoice/'.$value->invoice_number) }}" class="btn btn-light-primary btn-block">
