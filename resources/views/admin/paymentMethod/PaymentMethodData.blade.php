    ...
    <div class="table-responsive">
        <table class="table zero-configuration">
            <thead>
                <tr>
                    <th>SN</th>
                    <th>Payment Method Company Name</th>
                    <th>Status</th>
                    <th>Logo</th>
                    <th>Action</th>
                </tr>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ URL::to('public/images/paymeentLogo/'.$value->logo)}}" style="width: 75px;height: 33px;">
                    </td>
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changePaymentMethodStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getPaymentMethodid="{{$value->id}}" id="customSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deletePaymentMethod('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
