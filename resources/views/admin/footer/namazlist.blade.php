            ...
            <tbody >
                ...
                <tr>
                    ...
                    <div class="custom-control custom-switch custom-control-inline mb-1">
                        <input type="checkbox" class="custom-control-input changeNamazStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getNamzid="{{$value->id}}" id="customSwitch{{$value->id}}">
