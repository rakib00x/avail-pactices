                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content" id="body_data">
                                {!! Form::open(['id' =>'updateTerm','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                                            <div class="col-md-4">
                                        <label>Discription  <span style="color:red;">*</span></label>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <textarea type="text" id="descp" class="form-control meta_discription summernote" name="descp" required="" height="50%">{{$value->descp}}</textarea>
                                    </div>
...
<script type="text/javascript">
    ...
    $('body').on('submit', '#insertTermInfo', function (e) {
    e.preventDefault();

    var descp = $('[name="descp"]').val() ;
    if (descp == "") {
        toastr.info('Oh shit!! Please Input Decsription', { positionClass: 'toast-bottom-full-width', });
        return false;
    }
    ...
    $.ajax({
        ...
        success:function(data){
            if (data == "success") {
                ...
                $("#addModal").modal('hide');
                toastr.success('Thanks !! Terms and Condition Add Successfully Compeleted', {positionClass: 'toast-bottom-full-width', });

                return false;
            }else if(data == "failed"){
                toastr.error('Sorry !! Terms Not Added', { positionClass: 'toast-bottom-full-width', });
                return false;
            }else if(data == "duplicate_found"){
                toastr.error('Sorry !! Terms  Already Exist', { positionClass: 'toast-bottom-full-width', });
                return false;
            }
        }
    });
    ...
    $('body').on('submit', '#updateTerm', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            'type':'post',
            'dataType':'text',
            data: {descp:descp,primary_id:primary_id},
            success:function(data){
                ...
                if (data == "success") {
                    toastr.success('Thanks !!  Terms & Condition Update Successfully Compeleted', {positionClass: 'toast-bottom-full-width', });

                    return false;
                }else if(data == "failed"){
                    toastr.error('Sorry !!  Terms & Condition Not Updated', { positionClass: 'toast-bottom-full-width', });
                    return false;
                }else if(data == "duplicate_found"){
                    toastr.error('Sorry !!  This Terms & Condition  Already Exist', { positionClass: 'toast-bottom-full-width', });
                    return false;
                }
