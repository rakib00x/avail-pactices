    ...
    <div class="content-wrapper">
        <div class="content-body">
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title">Category Slider</h4>
                        <div class="card">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label>Choose Primary Category <span style="color:red;">*</span>
                                        </label>
                                    </div>
...
$("#insertCategorySlider").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('insertCategorySlider');
...
$(function(){
    $('body').on('click', '.changeCategorySliderStatus', function (e) {
        ...
        $.ajax({
            'url':"{{ url('/changeCategorySliderStatus') }}",
            'type':'post',
            'dataType':'text',
...
//update
$("#updateCategorySlider").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updateCategorySlider');
        let formData = new FormData(myForm);
