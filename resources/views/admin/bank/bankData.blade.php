        ...
        <table class="table zero-configuration">
            ...
            <tbody >
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ URL::to('public/images/bankLogo/'.$value->bank_logo)}}" alt="" style="width: 75px;height: 33px;">
                    </td>
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeBankStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getBankid="{{$value->id}}" id="customSwitch{{$value->id}}">
