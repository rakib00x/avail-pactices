                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a role="button" class="float-right btn btn-primary btn-md" id="addCategory">+ Add Bank Information</a>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3 class="modal-title" id="myModalLabel1">Add Bank Information</h3>
                            <button type="button" class="close" data-dismiss="modal">&times;</button>

                        </div>
                        <div class="modal-body">

                            {!! Form::open(['id' =>'insertBankInfo','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label>Bank Account Name <span style="color:red;">*</span>
                                        </label>
                                    </div>
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control bank_account_name" name="bank_account_name" required="">
                                    </div> 

                                    <div class="col-md-4">
                                        <label>Bank Branch Name <span style="color:red;">*</span>
                                        </label>
                                    </div>
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control bank_branch_name" name="bank_branch_name" required="">
                                    </div>
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control bank_account_number" name="bank_account_number" required="">
                                    </div>
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {!! Form::open(['id' =>'updateBankInfo','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
...
//insert
$("#insertBankInfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('insertBankInfo');
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                toastr.error('Sorry !! Bank Information Already Exist', { positionClass: 'toast-bottom-full-width', });
                return false;
            }else{
...
$(function(){
    $('body').on('click', '.changeBankStatus', function (e) {
        e.preventDefault();
...
//update
$("#updateBankInfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updateBankInfo');
        let formData = new FormData(myForm);
        ...
        $.ajax({
            ...
            if (data == "success") {
                ...
                toastr.error('Sorry !! Bank Information Not Updated', { positionClass: 'toast-bottom-full-width', });
                return false;
            }else if(data == "duplicate_found"){
                toastr.error('Sorry !! Bank Information Already Exist', { positionClass: 'toast-bottom-full-width', });
                return false;
