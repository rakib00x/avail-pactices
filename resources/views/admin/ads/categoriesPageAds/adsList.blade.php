            ...
            <section id="basic-datatable">
                <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <h4 class="card-title">Categories Page Ads List</h4>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {!! Form::open(['id' =>'insertAdminAds','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                            <div class="form-body">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-8 form-group">
                                        <input type="text" class="form-control" name="image_keyword" >
                                    </div> 
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            {!! Form::open(['id' =>'updateAdminAds','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
...
//insert
$("#insertAdminAds").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('insertAdminAds');
...
$(function(){
    $('body').on('click', '.changeAdminAdsStatus', function (e) {
        ...
        var ads_id = $(this).attr('getAdminAdsid');
...
//update
$("#updateAdminAds").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updateAdminAds');
        let formData = new FormData(myForm);
