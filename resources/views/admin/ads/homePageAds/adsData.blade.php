        ...
        <table class="table zero-configuration">
            ...
            <tbody >
                ...
                <tr>
                    <td>{{$i++}}</td>
                    <td>
                        <img src="{{ URL::to('public/images/adminAds/'.$value->ads_image)}}" style="width: 75px;height: 33px;">
                    </td>
                    ...
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeAdminHomeAdsStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getAdminHomeAdsid="{{$value->id}}" id="customSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deleteHomeAds('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
