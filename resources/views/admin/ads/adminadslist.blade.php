            ...
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <h4 class="card-title">Admin Ads List</h4>

                            <div class="card">
                                <div class="card-header">
                                   
                                    <a role="button" class="float-right btn btn-primary btn-md" id="addCategory">+ Add Admin Ads</a>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="myModalLabel1">Add Admin Ads</h3>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>

                            </div>
                            <div class="modal-body">

                                {!! Form::open(['id' =>'insertAdminListAds','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-4">
                ...
                <div class="modal fade" id="editModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="myModalLabel1">Update Admin Ads</h3>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>

                            </div>
                            <div class="modal-body">

                                {!! Form::open(['id' =>'updateAdminAdsListinfo','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                                    <div class="form-body" id="adminEditForm">
...
//insert
$("#insertAdminListAds").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('insertAdminListAds');
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == "success") {
                 ...
                 $("#addModal").modal('hide');
                        toastr.success('Thanks !! Admin Add Successfully Compeleted', {positionClass: 'toast-bottom-full-width', });

                        return false;
                    }else if(data == "failed"){
                        toastr.error('Sorry !!Admin ads Not Added', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else if(data == "duplicate_found"){
                        toastr.error('Sorry !! Admin ads Name Already Exist', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else{
                        toastr.info('Oh shit!! Admin Ads And Logo Can not be empty', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
 ...
 $(function(){
        $('body').on('click', '.changeAdminAdsStatus', function (e) {
            e.preventDefault();

            var ads_id = $(this).attr('getAds');
            ...
            $.ajax({
                'url':"{{ url('/changeAdminAdsStatuslist') }}",
                'type':'post',
                'dataType':'text',
                data:{ads_id:ads_id},
                success:function(data)
                {
                    ...
                    if(data == "success"){
                        toastr.success('Thanks !! The Admin Ads status has activated', { positionClass: 'toast-bottom-full-width', });
                        return false;
                        ...
                        toastr.error('Thanks !! The Admin Ads status has deactivated', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
                }
            });
...
//update
$("#updateAdminAdsListinfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updateAdminAdsListinfo');
        let formData = new FormData(myForm);
        ...
        $.ajax({
            'url':"{{ url('/updateAdminAdsListinfo') }}",
            'data': formData,
            'processData': false, // prevent jQuery from automatically transforming the data into a query string.
            'contentType': false,
            'type': 'POST',
...
function editAdmin(id) {
    ...
    $.ajax({
        'url':"{{ url('/editAdminListads') }}",
        'type':'post',
        'dataType':'text',
        data:{id:id},
        success:function(data){

            $("#adminEditForm").empty().html(data) ;
