<div class="card-body card-dashboard">
    <div class="table-responsive">
        <table class="table zero-configuration">
            ...
            <tr>
                <td>{{$i++}}</td>
                <td>{{$value->shippingCompanyName}}</td>
                <td>
                    <img src="{{ URL::to('public/images/adminShipping/'.$value->logo)}}" alt="" style="width: 75px;height: 33px;">
                </td>
                <td>
                    <div class="custom-control custom-switch custom-control-inline mb-1">
                        <input type="checkbox" class="custom-control-input changeShippingStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getShippingid="{{$value->id}}" id="customSwitch{{$value->id}}">
                ...
                <td>
                    <div class="invoice-action">
                        ...
                        <a onclick="deleteShipping('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
