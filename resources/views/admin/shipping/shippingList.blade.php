        ...
        <div class="content-wrapper">
            <div class="content-body">
                <section id="basic-datatable">
                    <div class="row">
                        <div class="col-12">
                            <h4 class="card-title">Shipping Company List</h4>
                            <div class="card">
                                <div class="card-header">
                                    <a role="button" class="float-right btn btn-primary btn-md" id="addCategory">+ Add Shipping Company</a>
                                </div>
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="myModalLabel1">Add Shipping Company</h3>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>

                            </div>
                            <div class="modal-body">

                                {!! Form::open(['id' =>'insertShippingInfo','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-8 form-group">
                                                <input type="text" class="form-control shippingCompanyName" name="shippingCompanyName" required="">
                                            </div>
                ...
                <div class="modal fade" id="editModal" role="dialog">
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h3 class="modal-title" id="myModalLabel1">Update Shipping Company </h3>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>

                            </div>
                            <div class="modal-body">

                                {!! Form::open(['id' =>'updateShippingInfo','method' => 'post','role' => 'form', 'class' => 'form form-horizontal', 'files'=>'true']) !!}
...
$("#insertShippingInfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('insertShippingInfo');
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data == "success") {
                 ...
                 $("#addModal").modal('hide');
                        toastr.success('Thanks !! Shipping Company Add Successfully Compeleted', {positionClass: 'toast-bottom-full-width', });

                        return false;
                    }else if(data == "failed"){
                        toastr.error('Sorry !! Shipping Company Not Added', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else if(data == "duplicate_found"){
                        toastr.error('Sorry !! Shipping Company Name Already Exist', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else{
                        toastr.info('Oh shit!! Shipping Company And Logo Can not be empty', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
    ...
    $(function(){
        $('body').on('click', '.changeShippingStatus', function (e) {
            e.preventDefault();

            var shipping_id = $(this).attr('getShippingid');
            ...
            $.ajax({
                ...
                success:function(data)
                {
                    ...
                    if(data == "success"){
                        toastr.success('Thanks !! The Shipping Company status has activated', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }else{
                        toastr.error('Thanks !! The Shipping Company status has deactivated', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
                }
            });
    ...
    $("#updateShippingInfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updateShippingInfo');
        let formData = new FormData(myForm);
        ...
        $.ajax({
            ...
            success: function(data) {
                 ...
                 $("#editModal").modal('hide') ;
                    if (data == "success") {
                        toastr.success('Thanks !! Shipping Company Name Update Successfully Compeleted', {positionClass: 'toast-bottom-full-width', });

                        return false;
                    }else if(data == "failed"){
                        toastr.error('Sorry !! Shipping Company Not Updated', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else if(data == "duplicate_found"){
                        toastr.error('Sorry !! Shipping Company Name Already Exist', { positionClass: 'toast-bottom-full-width', });
                            return false;
                    }else{
                        toastr.info('Oh shit!! Shipping Company Name And Logo Can not be empty', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
            ...
            $.ajax({
                ...
                success:function(data){
                    ...
                    if (data == "success") {
                        ...
                        toastr.error('Thanks !! You have Delete the Shipping Company', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }else{
                        toastr.error('Sorry !! Shipping Company Not Delete', { positionClass: 'toast-bottom-full-width', });
                        return false;
                    }
