    ...
    <div class="content-wrapper">
        <div class="content-body">
            <section id="basic-datatable">
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title">Tertiary Category Slider</h4>
                        <div class="card">
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $.ajax({
            'url':"{{ url('/getAllTertiaryCategorySlider') }}",
            'type':'post',
            'dataType':'text',
            success:function(data){
                $("#body_data").empty();
...
//insert
    $('body').on('submit', '#insertCategorySlider', function (e) {
        ...
        $.ajax({
            'url':"{{ url('/insertTertiaryCategorySlider') }}",
            'type':'post',
            'dataType':'text',
...
$(function(){
    $('body').on('click', '.changeCategorySliderStatus', function (e) {
        ...
        $.ajax({
            'url':"{{ url('/changeTertiaryCategorySliderStatus') }}",
            'type':'post',
            'dataType':'text',
...
$('body').on('submit', '#updateCategorySlider', function (e) {
    ...
    $.ajax({
        'url':"{{ url('/updateTertiaryCategorySlider') }}",
        'type':'post',
        'dataType':'text',
...
function deleteCategorySlider(id) {
    ...
    if (r == true) {
        ...
        $.ajax({
            'url':"{{ url('/tertiaryCategorySliderDelete') }}",
            'type':'post',
            'dataType':'text',
            data:{id:id},
            success:function(data){
...
function edit(id) {
    ...
    $.ajax({
        'url':"{{ url('/editTertiaryCategorySlider') }}",
        'type':'post',
        'dataType':'text',
        data:{id:id},
        success:function(data){
