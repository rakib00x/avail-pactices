            ...
            <tbody>
                ...
                @foreach($result as $value)
                    <tr>
                        ...
                        <td><img src="{{ URL::to('public/images/secCetegroy/'.$value->secondary_category_icon) }}" alt="" style="width: 75px;height: 33px;"></td>
                        <td>
                        ...
                        <td>
                            <div class="invoice-action">
                                ...
                                <a onclick="deleteSecondaryCategory('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
