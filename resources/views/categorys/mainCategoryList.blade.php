...
error: function(e) {
	...
	<script type="text/javascript">
        ...
        $.ajax({
            'url':"{{ url('/insertPrimaryCategoryInfo') }}",
            'data': formData,
		...
		//update
		$("#updatePrimaryCategoryInfo").submit(function(e){
        e.preventDefault() ;

        let myForm = document.getElementById('updatePrimaryCategoryInfo');
        let formData = new FormData(myForm);
        ...
        $.ajax({
            'url':"{{ url('/updatePrimaryCategoryInfo') }}",
            'data': formData,
            'processData': false, // prevent jQuery from automatically transforming the data into a query string.
            'contentType': false,
            'type': 'POST',
