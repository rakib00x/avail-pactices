...
(function() {
 ...
 <script>
        $(document).ready(function(){
            ...
            $.ajax({
                'url':"{{ url('/getAllSupplierProductMobile') }}",
                'type':'post',
                'dataType':'text',
        ...
        $('body').on('click', '.siam_class', function (e) {
            ...
            $("#table_data .siam_active").each(function(){
                ...
                val_arr.push('<li class="remove_project_file3 ui-state-default" id="item_info_'+random_id+'" style="margin-bottom: 30px;width:30%;float:left;margin-left: 6px;">'
                    + '<a href="#" style="color: red;font-size: 17px;position: absolute;" class="remove_project_file" border="2" getmainimageid="'+imageidvalue+'"><i class="fa fa-times" aria-hidden="true"></i></a>'
