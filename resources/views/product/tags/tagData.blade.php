                ...
                <tr>
                    ...
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeTagsStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getTagsid="{{$value->id}}" id="customSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deleteTags('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
