...
<a class="list-group-item list-group-item-action" id="list-escription-list" data-toggle="list" href="#list-description" role="tab">Description <span style="color: red!important;
    font-size: 15px;">*</span></a>
<a class="list-group-item list-group-item-action" id="list-Shipping-list" data-toggle="list" href="#list-Shipping" role="tab">Shipping Info</a>
                    ...
                    <div class="col-md-9 form-group">
                        <select class="form-control select2" id="product_web_category" name="product_web_category">
                            ...
                            <?php foreach ($all_web_category as $wvalue) { ?>
                                <option value="<?php echo $wvalue->id; ?>" <?php if($product_info->w_tertiary_categroy_id == $wvalue->id){echo "selected"; }else{echo ""; } ?>>{{ $wvalue->category_name."->".$wvalue->secondary_category_name."->".$wvalue->tartiary_category_name }}</option>
                            <?php } ?>
                        ...
                        <div class="form-group">
                            <select class="form-control" id="main_cateory_id" name="main_category_id">
                                ...
                                <?php foreach ($all_main_category as $mvalue) { ?>
                                    <option value="<?php echo $mvalue->id; ?>" <?php if($mvalue->id == $product_info->main_category_id){echo "selected"; }else{echo "";} ?>>{{ $mvalue->category_name }}</option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-9 form-group">
                        <div class="form-group">
                            <select class="form-control" id="secondary_category_id" name="secondary_category_id" >
                                <?php foreach ($all_secondary_category as $scvalue) { ?>
                                    <option value="<?php echo $scvalue->id; ?>" <?php if($scvalue->id == $product_info->secondary_category_id){echo "selected"; }else{echo "";} ?>><?php echo $scvalue->secondary_category_name."".$scvalue->id; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
        ...
        <div class="form-body">
            <div class="row">
                ...
                <?php if ($product_info->price_type != ""): ?>
                        ...
                        <div class="col-md-6 form-group unit_price_check">
