      ...
      <div class="col-md-12 col-md-offset-12">
       ...
       <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
             ...
             <div class="col-md-6">
                <div class="form-group">
                   ...
                   <input class="form-control" type="text" name="edu_qulification">
           ...
           <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                   ...
                   <input class="form-control" type="text" name="work_experience">
            ...
            <div class="col-md-6">
                <div class="form-group">
                   ...
                   <input class="form-control" type="text" name="work_area">
         ...
         <label for="term"> I have a check<a href="{{ URL::to('m/employee/terms') }}">Terms & Condition</a></label><br>
              <div class="row mt-1">
              <div class="col-md-12">
              ...
              I already have an account <a class="btn btn-primary" href="{{ route('employee.login') }}">Sign In</a>
           </form>
      </div>
   </div>
</div>
