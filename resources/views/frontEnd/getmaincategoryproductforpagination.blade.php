    ...
    <div class="column is-full mb-0">
        <?php foreach ($all_product as $justvalue): ?>
        	<div class="sonia box mr-2 p-2" style="border-bottom-left-radius: 6px !important;max-width: 225px;max-height: 400px;">
	            ...
	            <img style="width:209px !important;height: 209px;border-top-left-radius: 6px;border-top-right-radius: 6px;" src="{{ URL::to('public/images/'.$product1_image[0]) }}" style="width:175px; height:175px;" alt="{{ $justvalue->product_name }}" />
