...
<head>
	<meta charset="UTF-8">
	<title> @yield('title') |Availtrade</title>
		...
		<div class="container">
			<div class="columns">
				<div class="column is-one-fifth">
				    <h1 style="display:none;">availtrade</h1>
					<div class="logo">
						<a href="{{ URL::to('') }}" title=""><img src="{{ URL::to('public/images/'.$settings->logo) }}" style="width:163px; height:48px;" alt="availtrade"/></a>
					</div>
				</div>
									  ...
									  <div class="dropdown-trigger">
								  		...
								  		<a href="#" aria-haspopup="true" aria-controls="dropdown-menu4">
											...
											<div style="display: flex;">
											    ...
											    <img  src='{{ URL::to("$image_urlo") }}' style="height: 40px!important; margin-right: 5px;"/>
												<span style="line-height: 20px; margin: 6px;">{{ $supplier_info->storeName }}</span>
											</div>
										</a>
									  ...
									  <div class="dropdown-trigger">
                                       ...
                                       $seller_info = DB::table('express')->where('id', Session::get('supplier_id'))->first() ; 
											...
											<div style="display: flex;">
				                                ...
				                                <img  src='{{ URL::to("$image_ursl") }}' style="height: 40px!important; margin-right: 5px;" alt="$seller_info->first_name"/>

												<span style="line-height: 20px; margin: 6px;">{{ $seller_info->first_name." ".$seller_info->last_name }}</span>
									  ...
									  <div class="dropdown-trigger">
								  		...
								  		<a href="#" aria-haspopup="true" aria-controls="dropdown-menu4">
											...
											<div style="display: flex;">
				                                ...
				                                <img  src='{{ URL::to("$image_url") }}' style="height: 40px!important; margin-right: 5px;" alt="$customer_info->first_name"/>

												<span style="line-height: 20px; margin: 6px;">{{ $customer_info->first_name." ".$customer_info->last_name }}</span>
											</div>
										</a>
                                            ...
                                            <a href="{{ URL::to('login') }}" class="hover-signin" aria-haspopup="true" aria-controls="dropdown-menu4">
                                                <div style="display: flex;">
                                                    <div class="header-signin-mother">
                                                        <div class="header-signin-child-one" style="display: flex;">
                                                            <img src="{{ URL::to('public/images/Image 4.png') }}" style="height: 40px!important; margin-right: 5px;"/>
                                                            <span style="line-height: 20px; margin: 6px;">Sign in & <br/>Join free</span>
                                                        </div>
                                    ...
                                    <a href="#" onclick="showChatOptions(event)"  class="<?php if (Session::get('supplier_id') != null || Session::get('buyer_id') != null){echo "hover-message"; }else{echo " "; }?> ">
                                        <div class="header-message-mother">
                                            <div class="header-message-child-one">
                                                <img src="{{ URL::to('public/images/Image 5.png') }}"/><br/>
                                                <span>Messages</span>
                                            </div>
                                    ...
                                    <a href="{{ URL::to('cart') }}" class="trep">
                                        <div class="header-cart-mother">
                                            <div class="header-cart-child-one">
                                                <img src="{{ URL::to('public/images/Image 7.png') }}"/><br/>
                                                <span>Cart</span>
                                            </div>
                                            <div class="header-cart-child-two" style="display: none">
                ...
                <div id="pop-up" class="mout">
                    <div class="cart-parent">
                        <div class="cart-child-one">
                            <img src="{{ URL::to('public/images') }}/upper-arrow.png" alt="">
                        </div>
                        <?php if (Session::get('supplier_id') != null || Session::get('buyer_id') != null): ?>
                    ...
                    <div class="signin-parent">
                        ...
                        <div class="signin-child-two">
                            <div class="signin-pop">
                                <h3 style="font-size: 20px;font-weight: bold;margin-bottom: 10px;">Get started now</h3>
                                <a class="button is-link" style="width: 100% !important;background: #0088cc;" href="{{ URL::to('login') }}">Sign In</a>
                                <h3 style="font-size: 20px;font-weight: bold;text-align: center;padding: 0px;margin: 0px;">Or</h3>
                                <a class="button is-link" style="width: 100% !important;background: #28a745;margin-bottom: 10px;" href="{{ URL::to('registration') }}">Join Free</a>
                                <a class="button is-link" style="width: 100% !important;background: #3b5998;margin-bottom: 10px;" href="{{URL::to('loginwithfacebook')}}">Login with Facebook</a>
                                <a class="button is-link" style="width: 100% !important;background: #db4a39;margin-bottom: 10px;" href="{{URL::to('loginwithgmail')}}">Login with Google</a>
                                <a class="button is-link" style="width: 100% !important;background: #0e76a8;margin-bottom: 10px;" href="{{URL::to('loginwithlinkedin')}}">Login with Linkedin</a>
                    ...
                    <div class="order-parent">
                        ...
                        <div class="order-child-two">
                            ...
                            <?php if(Session::get('buyer_id')): ?>
                                ...
                                <hr style="padding: 0px;margin: 0px;margin-top: 4px;">
                                <div class="cart-button">
                            ...
                            <?php else: ?>
                                ...
                                <hr style="padding: 0px;margin: 0px;margin-top: 4px;">
                                <div class="cart-button">
                                    <a href="{{URL::to('supplierOrdersList')}}"><input type="submit" class="cart-submit" value="Order with trade assurance"></a>
                                </div>
                             <?php endif; ?>
                    </div>
                </div>
		...
		<div class="container">
		    <div class="columns is-full">
				...
				<ul>
						...
						<div class="header-category-1st">
							<ul>
								...
								<li id="dropdown">
										...
										<a href="{{ URL::to('/seccategory/'.$svalue->secondary_category_slug.'/heightolow')}}" style="padding:2px!important"><?php echo $svalue->secondary_category_name; ?></a> <?php if(count($all_sec_category_top3) == $key+1){ echo ""; }else{echo "/"; } ?>
									<?php endforeach ?>
									
									<div class="header-category-2nd" style="height:498px!important">
					...
					<h3 style="display:none;">availtrade</h3>
				</ul>
	    		...
	    		<div class="navbar-item has-dropdown is-hoverable">
                    ...
                    <a class="navbar-link"><img src="{{ URL::to('public/country_flags/') }}/<?php echo strtolower(Session::get('countrycode')).".png"; ?>" width="24" height="24" alt="availtrade">&nbsp;&nbsp;<?php 
...
@endphp
@if(count($namaz) > 0)
	<div style="background: #000;height: 2.5rem;">
	     
	    <marquee style="color:#54fd49;padding-top:1px;font-size:1.5rem;" scrollamount="4">
            ...
            <div class="columns ml-2">
                <div class="column is-one-third">
                    ...
                    <ul class="footer-list-controller">
                        <li><p style="font-size: 19px;color: #000;font-weight: bold;">Customer Care</p></li>
                    ...
                    <br>
                    <ul class="footer-list-controller">
                        <li><p style="font-size: 19px;color: #000;font-weight: bold;">Earn with Availtrade</p></li>
                ...
                <div class="column is-one-third">
                    <ul class="footer-list-controller">
                        <li><p style="font-size: 19px;color: #000;font-weight: bold;">Availtrade</p></li>
                        <li><a href="{{route('help')}}">Help Center</a></li>
                ...
                <div class="column is-auto">
                    <div class="is-flex" style="width: 500px; display: block; margin: 0 auto;">
    ...
    <section>
		<button class="chat-btn">
		    <?php
                $total_pending_count = DB::table('tbl_messages')->where('receiver_id', $main_login_id)->where('is_read', 0)->count() ;    
            ?>
			<span style="font-size:22px; "><span class="pending-messages">{{ $total_pending_count }}</span> Messanger</span>
		</button>
...
span.icon > i  {
    ...
    height:16px;
				...
				{{--	<p class="contact-name"><a href="{{URL::to('msBox')}}" style="color:red;">Messenger</a></p>--}}
                            ...
                            <?php if($getSupplierValue != $login_primary_id && $scQuery != null): ?>
    						   ...
    						   <div class="member sonia member_with_<?php echo $getSupplierValue; ?>" zamirul="<?php echo $scQuery->id; ?>" sabbir="<?php if($scQuery->type == 2){echo str_replace("-",' ',$scQuery->storeName); }else{echo $scQuery->first_name.' '.$scQuery->last_name ;} ?>" style="background-color:<?php if($unread_count > 0){echo "#e6e5ee"; }else{echo "#f8f8f8"; } ?>">
        							<div class="photo">
                                        ...
                                        @else
                                            <img class="avatar" src="<?php echo $image_url_2; ?>" alt="">
                                        @endif
        							</div>
        							<div class="userinfo">
	...
	<?php else: ?>
        ...
        <section id="chat_section_main">
            <a href="#" onclick="showLoginModal(event)" class="emty-chat-box">
                <span style="font-size:22px;">Messanger</span>
            </a>
    	</section>
	<?php endif ?>
...
<div id="ex1" style="width: 800px !important;" class="container modal">
	<div class="columns is-gapless">
		<div class="column is-full" style="background: #fff; height: 465px;">
			<div class="p-5">
                ...
                <?php if($customer_id_main == null || $customer_id_main == ""): ?>
				    <h3 id="modal_display_none" style="color:red; font-weight:bold;">Please Login First <a href="{{ URL::to('login') }}">Login</a></h3>
				<?php endif ; ?>
				<br>
...
<!-- start of sending message to supplier -->
<div id="login_modal" style="width: 500px !important;" class="container modal">
	<div class="columns is-gapless">
		<div class="column is-full" style="background: #fff; height: 465px;">
		    <div class="login-box">
                ...
                @endif
                <center><h3 style="font-size: 30px;">Login</h3></center>
                ...
                {!! Form::open(['id' =>'buyerSignIn','method' => 'post','role' => 'form', 'files' => true]) !!}
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                <label>Password:</label><span style="float: right;"><a href="{{ URL::to('forgot-password') }}">forget password ?</a></span><br>
                             ...
                             <td style="padding-top:13px !important;"><span id="togglePasswordshow" class="fa fa-eye fa-eye-slash" style="margin-left: -33px;margin-top: 23px;"></span></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <label>Mobile Number Sign In</label><span style="float: right;"><a href="{{ URL::to('registration') }}">Join Free</a></span><br>
                            </td>
                        </tr>
                    </table>
...
@if($active_popup_ads)
    ...
    <div id="popupads" style="width: 600px !important;height: 310px !important;" class="container modal">
