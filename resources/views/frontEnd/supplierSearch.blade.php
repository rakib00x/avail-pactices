                    ...
                    <div class="columns mb-0 pb-0">
                        <div class="column">
                            <div class="tabs is-boxed" style="border-bottom: 1px solid #d4dae3;">
                                <ul>
                                    <li>&nbsp;</li>
                                    <li style="background: #ffffff;border: 1px solid #d4dae3;border-bottom: none;">
                                        <a>
                                            <span style="color: #d4dae3;">Suppliers</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                                    ...
                                    <div class="column">
                                        <table style="font-size: 15px;">
                                            ...
                                            <tr>
                                                <td>&nbsp;&nbsp;</td>
                                                <td>&nbsp;&nbsp;</td>
                                                <td><a class="contact-supplier" href="#" onclick="sendquotationinfo(<?php echo $supplierSearch->id; ?>, '<?php echo $supplierSearch->storeName;  ?>')"><i class="far fa-envelope"></i> Contact Supplier</a> &nbsp;&nbsp;&nbsp; <img src="{{ URL::to('public/frontEnd/images/chat.png') }}" alt="">
                                                <a style="font-size: 16px;" href="#" onclick="chatshowpage({{ $supplierSearch->id }},<?php echo $main_login_id; ?>)"> Chat Now</a></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
...
@section('js')
<script>
    function chatshowpage(receiver_id, senderid){
        ...
        var supplier_name = '<?php  if(count($supplier_search) > 0){ echo $supplierSearch->first_name." ".$supplierSearch->last_name; } ?>';
