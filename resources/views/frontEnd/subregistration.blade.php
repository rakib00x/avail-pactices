...
@section('css')
<link rel="stylesheet" type="text/css" href="{{ URL::to('public/frontEnd/assets/css/subregistration.css') }}">
@endsection
@section('content')
<div class="wrapper" style="background: #f4f4f4;">
        ...
        <div class="columns">
            ...
            <div class="column is-three-fifths is-offset-one-fifth box mb-5 pt-5">
                <h1 class="pl-5 pb-5" style="font-size: 30px;font-weight: bold;margin-left:14rem;">Supplier Registration</h1>
                <div class="columns pb-5 pl-5">
                	<form enctype="multipart/form-data" onsubmit="return mySubmitFunction(event)" method="post" >
                    <table>
                        <tr>
                            <input type="hidden" name="user_type" class="user_type" id="user_type" value="2">
                        ...
                        <tr class="store_name_validation" >
                            <td class="td-right">Store Name</td>
                            <td>&nbsp;&nbsp;</td>
                            <td>
                            	<span id="store_section" class="store_name_validation"></span>
                                <input class="reg-input" name="store_name" id="store_name" type="text" >
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>&nbsp;&nbsp;</td>
                            <td>
                                &nbsp;&nbsp;Didn't Have An Supplier Account? <a href="{{ URL::to('registration') }}">Buyer Registration</a>
                            </td>
                        </tr>
