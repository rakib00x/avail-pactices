...
@endsection
@section('content')
	<div class="container mt-5 colorss">
		<div class="columns is-gapless">
			<div class="column is-one-fifth pr-5">

                <!-- My Market -->
				<div class="sidebar-navbar colorss">
					<h2 class="ml-2 categor"><strong>MY MARKETS</strong></h2>

					<ul>

						@foreach($primarycategory as $value)
						<a class="alinks" href="{{ URL::to('category/'.$value->catgeory_slug) }}/heightolow" title="{{ $value->category_name }}">
							<li id="dropdown" class="evanyou">
								<img src="{{URL::to('public/images/mainCtegory/'.$value->category_icon)}}" alt="{{ $value->category_name }}"/> <span class="categoryd"><?php $catname = $value->category_name; $strlen = strlen($catname); if($strlen == 24 || $strlen < 24){ echo $catname; }else{ echo substr($catname,0,24); } ?></span>
								<img src="{{ URL::to('public/images/right-arrow.png') }}" class="is-pulled-right imagess" style="" alt="availtrade"/>
								<div class="sidebar-navbar-mega-dropdown sidabaras">
									<div class="is-flex">
										<?php
										...
										@foreach($secondaryCategory as $subcat)
											<div class="sidesdsd">
												<a class="alinks" href="{{ URL::to('seccategory/'.$subcat->secondary_category_slug.'/heightolow') }}" title="" target="_blank" rel="noopener"><p><strong>{{$subcat->secondary_category_name}}</strong></p></a>
												<ul>
													<?php
									...
									<div class="is-flex">
										...
										@foreach($secondaryCategory2 as $subcat2)
											<div class="sidesdsd">
												<a class="alinks" href="{{ URL::to('seccategory/'.$subcat2->secondary_category_slug.'/heightolow') }}" title="" target="_blank" rel="noopener"><p><strong>{{ $subcat2->secondary_category_name }}</strong></p></a>
												<ul>
													<?php
						...
						@endforeach
						<li>
							<a class="alinks" href="{{URL::to('/all-categories')}}" title="All Categories"><img src="{{ URL::to('public/images/Image 15.png') }}"/> All Categories</a>
						</li>
					</ul>
				</div>
			</div>
                ...
                <div id="main-inner">
					<div id="slider">
                        @foreach($slider as $value)
                            <img class="sidesd" src="{{ URL::to('public/images/homeSlider/'.$value->slider_image)}}"  alt="availtrade" />
                        @endforeach
                    </div>
                </div>
			</div>
                    ...
                    <div class="colorss">
                        <div class="columns is-gapless is-multiline" >
                            ...
                            <div class="column is-one-quarter m-0 p-0">
                            	<a class="alinkss"  href="{{ URL::to('product/'.$catproduct->slug)}}" title="{{ Str::limit($catproduct->product_name,20) }}">
                            		<div class="cateproduct">
	                                    <p><strong>{{ Str::limit($catproduct->product_name,20) }}</strong></p>
	                                    <div class="columns">
	                                        <div  class="column">
	                                            <div class="content contsize">
	                                                <?php
	                                        ...
	                                        <div class="column">
                                               ...
                                               ?>
                                               <img class="contproduimg" src="{{ URL::to('public/images/'.$image_name) }}" alt="{{ $catproduct->product_name }}" />
                                            </div>
                    ...
                    ?>
	                    ...
	                    <div class="box justproyoursd">
	                    	<a href="{{ URL::to('product/'.$justvalue->slug)}}" title="" style="color:black!important">
		                        ...
		                        <img src="{{ URL::to('public/images/'.$justvalueimage[0]) }}" style="width:225px; height:225px;" alt="{{ $justvalue->product_name }}" />
                            ...
                            <p class="right-fok mb-0"><i class="fas fa-eye"></i> {{ $justvalue->visitor_count }}</p>
			            </div>
                ...
                <div class="flags">
                    <ul>
                        ...
                        <?php if ($country_info): ?>
	                        ...
	                        ?>
	                        <li>
	                           <a class="alinhjg" href="{{ URL::to('country/'.strtolower($country->countryCode)) }}" >
	                                <img class="contryscss" src="{{ URL::to('public/country_flags/') }}/<?php echo strtolower($country->countryCode).'.png'; ?>"  alt="availtrade">
	                            </a>
	                        </li>
	                        <?php endforeach ?>
	                        <?php endif ; ?>
