<?php foreach ($product_result as $pro_value) { ?>
	<div class="col-lg-2 col-6 col-sm-3 col-md-4">
		<div class="product-default inner-quickview inner-icon">

			<figure>
				<a target="_blank" href="{{ URL::to('product/'.$pro_value->slug)}}">
					<?php $image_explode = explode("#", $pro_value->products_image); ?>
					<img src="{{ URL::to('public/images/'.$image_explode[0])}}" height="150" width="150">
				</a>
	
				@if ($pro_value->price_type == "2")
					<div class="label-group">
						...
						@endphp
							@php
								...
								->where('product_id', $pro_value->id)
								->where('supplier_id', $pro_value->supplier_id)
								->first() ;
							@endphp
			...
			<div class="product-details">
				<h3 class="product-title">
					<a href="{{ URL::to('product/'.$pro_value->slug)}}"><?php echo $pro_value->product_name; ?></a>
				</h3>
	
				<div class="price-box">
	
					@if ($pro_value->price_type == "4" || $pro_value->price_type == "1")
						...
						<?php if($product_price_section_2 > 0): ?>
							@php
								$small_price_1 = DB::table('tbl_product_price')
									...
									->where('tbl_product_price.product_id', $pro_value->id)
									->where('tbl_product_price.supplier_id', $pro_value->supplier_id)
