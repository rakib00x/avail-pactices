...
@section('content')
    ...
    <div class="container mt-2 mb-2">
        ...
        <!-- Store Slider -->
        <div class="columns m-0 p-0 mb-4 pb-2">
        ...
        <div class="columns is-gapless">
                        ...
                        <div class="column">
                            ...
                            <div id="store-main-inner">
                                <div id="store-slider">
                                    ...
                                    <a href="{{ $slidervalue->ads_link }}" title="" target="_new"><img src="{{ URL::to('public/images/'.$slidervalue->ads_image) }}" class="store-img-size"/></a>
                                    <?php endforeach ?>
                                </div>
                            </div>
                    ...
                    <div class="columns">
                        <div class="column">
                            ...
                            <div class="mb-1">
                                ...
                                <p class="text-right mb-0" style="float:right"><i class="fas fa-eye"></i> {{ $catgeoryproduct->visitor_count }}</p>
                            </div>
                        <?php endforeach ?>
            ...
            <div class="column auto ml-0 pt-0">
                            ...
                            <tr>
                                <td>
                                    {!! Form::open(['url' =>'ssearch','method' => 'get','role' => 'form', 'files'=>true]) !!}
                                        <input class="input" type="hidden" name="keywords" value="<?php echo $keywords; ?>">
                                        <input class="input" type="hidden" name="store" value="<?php echo strtolower($storeName); ?>">
                                        <input type="hidden" name="filter" value="{{ $pricefilter }}">
                            ...
                            <tr>
                                <td>
                                    <select name="" style="padding: 8px 10px;font-size: 18px;font-weight: bold;" id="pricefilter">
                                        <option value="heightolow" <?php if($pricefilter == "heightolow"){echo "selected"; }else{echo ""; }?>>High To Low</option>
                                        <option value="lowtoheigh" <?php if($pricefilter == "lowtoheigh"){echo "selected"; }else{echo ""; } ?>>Low to High</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                ...
                <!-- Start of Products -->
                <div class="columns is-full ml-0 mt-0 mr-0 is-multiline mb-5" id="product_data">
                        <?php 
                        ...
                        <div class="column is-one-quarter mt-4 ml-2 m-0 pt-0 box" style="width: 24% !important;">
                            ...
                            <a href="{{ URL::to('product/'.$justvalue->slug)}}" title="" style="color:black">
                                ...
                                <img src="{{ URL::to('public/images/'.$justvalueimage[0]) }}" alt="{{ $justvalue->product_name }}" style="width: 100%;height:255px;margin-top: 10px;">
                ...
                <div class="columns is-full mb-5">
                    <div class="column">
                        ...
                        {{ $just_for_you->appends(['keywrods' => $keywords,'store' => strtolower($storeName), 'filter' => $pricefilter, 'type' => $type])->render('frontEnd.store.customPaginate') }}
...
@section('js')
    ...
    <script>
        ...
        $("#pricefilter").change(function(){
            ...
            var main_link = "<?php echo env('APP_URL'); ?>ssearch?";
            var gridlink = main_link+"keywrods="+keywords+"&store="+storename+"&filter="+pricefilter+"&type="+viewstyle;
