                    ...
                    <div class="columns ml-2 mt-0 mb-5 mr-0 box mb-2">
                            ...
                            <div class="column auto mt-0 pt-0">
                                ...
                                <nav>
                                    ...
                                    <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                    <label><a href="#" onclick="supplierChatPageShow({{ $main_login_id }}, {{ $store_info->id }}, '{{ $store_info->storeName }}')"><img src="{{ URL::to('public/frontEnd/images/chat.png') }}" alt=""> Chat Now</a></label>
                                </nav>
                            </div>
