...
<?php 
	...
	if($banner_info){
	    if($banner_info->header_image){
	        $supplier_main_logo = $store_info->image;
	    }else{
    ...
    <div class="container mt-2 mb-2">
        ...
        <div class="columns m-0 p-0 mb-4 pb-2">
            <div class="column m-0 p-0">
                <?php $category_info = DB::table('tbl_supplier_primary_category')->where('catgeory_slug', $slug)->first(); ?>
...
@section('js')
    ...
    <script>
        ...
        function showlistview(){
            ...
            var main_link = "<?php echo env('APP_URL'); ?>stp-category";
