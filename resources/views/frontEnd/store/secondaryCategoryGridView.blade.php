    ...
    <div class="container mt-2 mb-2">
        ...
        <div class="columns m-0 p-0 mb-4 pb-2">
            <div class="column m-0 p-0">
                <?php $category_info = DB::table('tbl_supplier_secondary_category')->where('secondary_category_slug', $slug)->first(); ?>
                <h3>{{ $category_info->secondary_category_name }}</h3>
            </div>
        </div>
        ...
        <div class="columns is-gapless">
            ...
            <div class="column auto ml-0 pt-0">
                ...
                <div class="columns ml-0 mt-0 mr-0 mb-0 pt-0">
                    <div class="column mr-0 pr-0 mt-0 pt-0">
                        <table>
                            <tr>
                                <td>
                                    <a onclick="showlistview()"  class="button  listview viewstyle" type="submit">
                                    <i class="fas fa-th-list"></i></a>
                                    
                                </td>
                                <td style="padding:0px 5px;">
                                     <a onclick="showgridview()" class="button active gridview viewstyle" type="submit">
                            ...
                            <tr>
                                <td>
                                    <select name="" style="padding: 8px 10px;font-size: 18px;font-weight: bold;" id="pricefilter">
                                        ...
                                        <option value="lowtohigh" <?php if($pricefilter == "lowtohigh"){echo "selected"; }else{echo ""; } ?>>Low to High</option>
                                    </select>
                                </td>
                            </tr>
                        </table>
                ...
                <!-- Start of Products -->
                <div class="columns is-full ml-0 mt-0 mr-0 is-multiline mb-5">
...
@section('js')
    <script>
        ...
        function showlistview(){
            ...
            var main_link = "<?php echo env('APP_URL'); ?>sps-category";
            var gridlink = main_link+"/"+storename+"/"+slug+"/"+viewstyle+"/"+pricefilter;
