                            ...
                            <div id="store-main-inner">
                                <div id="store-slider">
                                    <?php $product_ads = DB::table('tbl_product_ads')->inRandomOrder()->where('status', 1)->get() ; foreach ($product_ads as $key => $slidervalue): ?>
                                     <a href="<?php echo $slidervalue->ads_link; ?>" ><img src="{{ URL::to('public/images/adminssAds/'.$slidervalue->ads_image) }}" alt="{{ $slidervalue->title }}" class="store-img-size"/></a>
                                    <?php endforeach ?>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="mb-1">
                                <div class="columns">
                                    ...
                                    <div class="column ml-0 pl-0">
                                        <a href="{{ URL::to('product/'.$catgeoryproduct->slug)}}">
                            ...
                            <tr>
                                <td>
                                    <select name="" style="padding: 8px 10px;font-size: 18px;font-weight: bold;" id="pricefilter">
                                        <option value="heightolow">High To Low</option>
...
@section('js')
    ...
    <script>
        ...
        function showlistview(){
            ...
            viewstyle = "l" ;
            var storename = "<?php echo strtolower($store_name); ?>";
