                        ...
                        <div class="column">
                            ...
                            <div id="store-main-inner">
                                <div id="store-slider">
                                    ...
                                    <a href="{{ $slidervalue->ads_link }}" title="" target="_new"><img src="{{ URL::to('public/images/adminssAds/'.$slidervalue->ads_image) }}" alt="{{ $slidervalue->title }}" class="store-img-size"/></a>
                                    <?php endforeach ?>
                                </div>
                            </div>
                ...
                <div class="columns is-full ml-0 mt-0 mr-0 is-multiline mb-5">
                        ...
                        <div class="column is-one-quarter mt-4 ml-2 m-0 pt-0 box" style="width: 24% !important;">
                            ...
                            <nav  class="mt-2">
                                ...
                                <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                                <label><a href="sss"><img src="images/chat.png" alt=""></a></label>
                            </nav>
