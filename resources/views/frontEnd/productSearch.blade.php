            ...
            <div class="columns">
                <div class="column">
                    <?php if ($serach_banner): ?>
                        <img src="{{ URL::to('public/images/Banner/') }}/{{ $serach_banner->image }}" alt="" style="height:136px!important;width:100%">
                    <?php endif ?>
                </div>
            </div>
                                ...
                                <tr>
                                    ...
                                    <td style="padding:0px 5px;">
                                        {!! Form::open(['url' =>'search','method' => 'get','role' => 'form', 'files'=>'true']) !!}
                                            ...
                                            <button class="button <?php if($type=="G"){echo "active";}else{echo ""; } ?>" type="submit" ><i class="fas fa-th-large"></i></button>
                                        {!! Form::close() !!}
                                    </td>
                                </tr>
                            </table>
                        ...
                        <div class="columns ml-5 mt-0 mb-5 mr-0 box mb-2">
                            ...
                            <div class="column is-one-quarter mb-0 pb-0">
                                <a href="{{ URL::to('product/'.$searchvalue->slug)}}" title="">
                                    ...
                                    <img src="{{ URL::to('public/images/'.$second_image_explode_3[0]) }}" alt="{{ $searchvalue->product_name }}" style="width: 100%;height:255px;" >
                                </a>
                            </div>
...
@section('js')
<script>
        function chatshowpage(product_id, receiver_id, senderid, storeName){
