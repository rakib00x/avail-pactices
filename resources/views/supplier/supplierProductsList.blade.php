...
@section('title','Suppliers Product List')
@section('content')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <a style="margin-bottom: -25px;" href="{{URL::to ('/productInformation')}}" class="btn btn-primary float-right" role="button" aria-pressed="true">Product Add</a>
                                </div>
