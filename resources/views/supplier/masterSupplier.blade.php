<?php
    ...
    if($supplier_id == null && $supplier_type == null && $seller_type == null){
        return Redirect::to('/login')->send();
        exit();
    }
    
    if($supplier_id == null && $supplier_type != '2' && $seller_type != 0){
        return Redirect::to('/login')->send();
        exit();
    }
    
    if($supplier_type != '2' && $seller_type != 0){
        return Redirect::to('/login')->send();
        exit();
    }
    ...
    $package_settings = DB::table('tbl_package')->where('id', $supplier_info->package_id)->first() ;
?>
...
<head>
    ...
    <title>Avail Trade || @yield('title','Supplier Dasboard')</title>
                ...
                <div class="navbar-collapse" id="navbar-mobile">
                    <div class="mr-auto float-left bookmark-wrapper d-flex align-items-center">
                       ...
                       <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{URL::to('msBox')}}" data-toggle="tooltip" data-placement="top" title="Chat"><i class="ficon bx bx-chat"></i></a></li>
                         ...
                         <li class="nav-item d-none d-lg-block"><a class="nav-link" target="new" href="{{ URL::to('store/'.strtolower($supplier_info->storeName)) }}" data-toggle="tooltip" data-placement="top"    title="Visit Your Web" ><h4 style="color:white;">Visite Your Site</b></h4></i></a></li>
                                    ...
                                    <div class="d-flex justify-content-between cursor-pointer">
                                        <div class="media d-flex align-items-center">
                                            ...
                                            <div class="media-body">
                                                <a href="{{ URL::to('supplierinvoice/'.$ordervalue->invoice_number) }}"><h6 class="media-heading"><span class="text-bold-500"><?php if($ordervalue->type == 2){echo $ordervalue->storeName; }else{echo $ordervalue->first_name." ".$ordervalue->last_name; } ?></span> </h6>
...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            <li class=" nav-item"><a href="{{ URL::to('supplierDashboard') }}"><i class="menu-livicon" data-icon="desktop"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span></a>
            </li>

            <li class=" nav-item"><a href="{{URL::to('/supplierAccountSettings')}}"><i class="menu-livicon" data-icon="wrench"></i><span class="menu-title" data-i18n="Account Settings">Account Settings</span></a>
            </li>

            <li class=" nav-item"><a href="{{URL::to('/supplierCategory')}}"><i class="menu-livicon" data-icon="rotate-right"></i><span class="menu-title" data-i18n="Categorys">Categorys</span></a>
            </li>
            <li class=" nav-item"><a href="{{URL::to('/supplierProductsList')}}"><i class="menu-livicon" data-icon="list"></i><span class="menu-title" data-i18n="Product">Product List</span></a>
            </li>
            
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="morph-folder"></i><span class="menu-title" data-i18n="User"> Page Settings</span></a>
                <ul class="menu-content">
                    <li><a href="{{URL::to('/supplierBrandList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Brand List</span></a>
                    </li>
                     <li class=" nav-item"><a href="{{URL::to('/supplierSliderList')}}"><i class="bx bx-right-arrow-alt" data-icon="wrench"></i><span class="menu-title" data-i18n="Account Settings">Slider List</span></a>
                    </li>
                    <?php if($package_settings->social_media_status == 1): ?>
                    <li><a href="{{URL::to('/supplierSoicalMedia')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Social Media</span></a>
                    </li>
                    <?php endif; ?>
                    <?php if($package_settings->banner_update_status == 1): ?>
                    <li><a href="{{URL::to('/headerbanner')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Header Banner</span></a>
                    </li> 
                    <?php endif; ?>
                </ul>
            </li> 
            {{--<li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="users"></i><span class="menu-title" data-i18n="User"style="color:red!important">Products</span></a>
                <ul class="menu-content">
                    <li><a href="{{URL::to('/supplierBrandList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Brand List</span></a>
                    </li>
                    <li><a href="{{URL::to('/sizeList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Sizes List</span></a>
                    </li>
                     <li><a href="{{URL::to('/supplierProductsList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Products List</span></a>
                    </li>
                   <li><a href="{{URL::to('/productInformation')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Product Add</span></a>
                    </li>
                     <li style="display: none;"><a href="{{URL::to('/tagsList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Tags List</span></a>
                    </li>
                </ul>
            </li>--}}
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="shoppingcart"></i><span class="menu-title" data-i18n="Invoice">Orders</span></a>
                <ul class="menu-content">
                    <li><a href="{{URL::to('/supplierOrdersList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Sell Orders List</span></a>
                    </li>
                    <li><a href="{{URL::to('/supplierOrderBuyList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Buy Orders List</span></a>
                    </li>
                </ul>
            </li> 

          
                <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="image"></i><span class="menu-title" data-i18n="User">Media</span></a>
                    <ul class="menu-content">
                        <li><a href="{{URL::to('/supplierMedia')}}"><i class="bx bxs-file-image"></i><span class="menu-item" data-i18n="List">Media</span></a>
                        </li>
    
                        <li><a href="{{URL::to('/supplierMediaTrash')}}"><i class="bx bx-trash-alt"></i><span class="menu-item" data-i18n="List">Trash</span></a>
                        </li>
                    </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="envelope-pull"></i><span class="menu-title" data-i18n="Invoice">Message</span> <span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
                ...
                <ul class="menu-content">
                    <li><a href="{{URL::to('/supplierQuotationList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Inbox </span> <span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
                <?php echo $quotation_count + $total_receive_message_count; ?></span></a>
                    <li><a href="{{URL::to('/supplierQuotationInbox')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="Invoice List">Send </span> <span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
              ...
              <li class=" nav-item"><a href="{{ URL::to('supplierAllReview') }}"><i class="menu-livicon" data-icon="notebook"></i><span class="menu-title" data-i18n="Account Settings">My Reviews</span> <span class="badge badge-light-danger badge-pill badge-round float-right mr-2">
                <?php 
            ...
            <li class=" nav-item"><a href="{{URL::to('/spu')}}"><i class="menu-livicon" data-icon="sort" style="color:red!important"></i><span class="menu-title" data-i18n="Package Update" style="color:red!important">Package Update</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="{{URL::to('/suppliertermsconditions')}}"><i class="menu-livicon" data-icon="gears"></i><span class="menu-title" data-i18n="Terms & Conditions"style="color:red!important">Terms & Conditions</span></a>
            
            <li class=" nav-item"><a href="{{URL::to('/ticketSection')}}"><i class="menu-livicon" data-icon="question"></i><span class="menu-title" data-i18n="Account Settings">Ticket To Availtrade</span></a>
            </li>
            
            {{-- <li class=" nav-item"><a href="#"><i class="menu-livicon" data-icon="users"></i><span class="menu-title" data-i18n="User">Web Header Menu</span></a>
                <ul class="menu-content">
                   <li><a href="{{URL::to('/mainMenuList')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Header Menu</span></a>
                    </li> 

                    <li style="display:none"><a href="{{URL::to('/menuBackgroundColor')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Header Color Change</span></a>
                    </li> 
                    <?php if($package_settings->banner_update_status == 1): ?>
                    <li><a href="{{URL::to('/headerbanner')}}"><i class="bx bx-right-arrow-alt"></i><span class="menu-item" data-i18n="List">Header Banner</span></a>
                    </li> 
