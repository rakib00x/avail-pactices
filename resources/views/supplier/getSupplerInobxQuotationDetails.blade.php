        ...
        <section class="chat-window-wrapper" >
          <div class="chat-area">
            ...
            <div class="card chat-wrapper shadow-none">
              <div class="card-body chat-container ps ps--active-y chat_main_box" style="height:421px">
                <div class="chat-content quation_reply" id="chatbox_s<?php echo $qutation_value->id; ?>" style=" overflow-y:scroll;overflow-x:hidden;height:400px;">
                    
                    <?php foreach($get_quotation_reply as $replyMessage): ?>
                      <div class="chat <?php if($replyMessage->sender_id == Session::get('supplier_id')){echo ''; }else{echo 'chat-left';} ?>">
                        <div class="chat-body">
                          <div class="chat-message" style="width:70%!important">
                            <p><strong>  
                            <?php if($replyMessage->sender_id == Session::get('supplier_id')){
                                $receiver_info = DB::table('express')->where('id', Session::get('supplier_id'))->first() ;
              ...
              <div class="card-footer chat-footer border-top px-2 pt-1 pb-0 mb-1">
                ...
                <form class="d-flex align-items-center" onsubmit="supplierInboxChatMessagesSend(event, <?php echo $qutation_value->id; ?>);">
