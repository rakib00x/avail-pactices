                    ...
                    <div class="col-6 mb-1" >
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <a href="#" title="Delete" class="btn btn-success" onclick="supplierTrashImageRestore()">Restore &nbsp;</a>
                            </div>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        ...
        function supplierTrashImageRestore() {
            ...
            if (r == true) {
                ...
                $.ajax({
                    'url':"{{ url('/supplierTrashImageRestore') }}",
                    'type':'post',
                    'dataType':'text',
                    success:function(data){
        ...
        function deleteSupplierAllTrashImage() {
            ...
            if (r == true) {
                ...
                $.ajax({
                    'url':"{{ url('/deleteSupplierAllTrashImage') }}",
                    'type':'post',
                    'dataType':'text',
                    success:function(data){
        ...
        function fetch_data(page, search_value)
        {
            ...
            $.ajax({
                url:"{{ url('getMediaTrashPagnationResult') }}",
                method:"POST",
        ...
        $("#mediaSearch").click(function(e){
            ...
            $.ajax({
                'url':"{{ url('/getTrashMediaSearchValue') }}",
                'type':'post',
                'dataType':'text',
