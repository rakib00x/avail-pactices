<?php foreach ($media_result as $value) { ?>
    <div class="col-md-2 siam_class" style="width: 50%;" id="image_product_id_<?php echo $value->id ; ?>">
        <div class="card" >
          <img class="card-img-top img-thumbnail" src="{{URL::to('public/images/'.$value->image)}}" alt="image" style="height: 100px;">
