                ...
                <tr>
                    ...
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeSizeStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getSizeid="{{$value->id}}" id="customSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deleteSize('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
