        ...
        <table class="table zero-configuration">
            ...
            <tbody >
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ URL::to('public/images/supplierSlider/'.$value->slider_image)}}" alt="" style="width: 75px;height: 33px;">
                    </td>
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeSliderStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getSliderid="{{$value->id}}" id="customSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deleteSlider('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
