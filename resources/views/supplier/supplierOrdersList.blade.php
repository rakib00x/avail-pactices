                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="invoice-action">
                                                <a href="{{ URL::to('supplierinvoice/'.$value->invoice_number) }}" class="invoice-action-view mr-1">
                                                    <i class="bx bx-show-alt"></i>
                                                </a>
                                                <a href="{{ URL::to('editinvoice/'.$value->invoice_number) }}" class="invoice-action-edit cursor-pointer">
