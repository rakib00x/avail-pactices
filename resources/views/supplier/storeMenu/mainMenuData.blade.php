                ...
                <tr>
                    ...
                    <td>
                        <div class="custom-control custom-switch custom-control-inline mb-1">
                            <input type="checkbox" class="custom-control-input changeMenuStatus" <?php if($value->status == 1){ echo 'checked'; }else{ echo ''; } ?> getMenuid="{{$value->id}}" id="supplierSwitch{{$value->id}}">
                    ...
                    <td>
                        <div class="invoice-action">
                            ...
                            <a onclick="deleteMenu('{{$value->id}}')" class="invoice-action-view mr-1" style="cursor: pointer;">
