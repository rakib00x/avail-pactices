...
@section('content')
	...
	<marquee style="color:#fff;font-size:1rem;" scrollamount="4">
	  Avail Trade পক্ষ থেকে পবিত্র মাহে রমজানের শুভেচ্ছা  নামাজের সময়সূচি 
	   ...
	   @endforeach
        ...
        <!-- Top Products-->
        <div class="top-products-area py-3" style="padding-top: 77px!important;">
            <div class="container">
...
@section('page_headline')
    {{ $tertiary_category->tartiary_category_name }}
@endsection
...
<script>
    ...
    $("#pricefilter").change(function(){
        ...
        var main_link   = "{{ URL::to('/m/tercategory') }}"+"/<?php echo $category_slug; ?>"+"/"+pricefilter;
        window.location = main_link;
    });
  ...
  $(document).ready(function(){
   ...
   function loadData(limit, start)
   {
    ...
    $.ajax({
     url:"{{ url('/gettertiarycategoryproductpaginate') }}",
     method:"POST",
