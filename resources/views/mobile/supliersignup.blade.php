            ...
            <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><img class="big-logo" src="img/core-img/logo-white.png" alt="">
                ...
                <div class="register-form mt-5 px-4">
                    <form enctype="multipart/form-data" onsubmit="mySubmitFunction(event)" method="post" >
                        ...
                        <div class="form-group text-start mb-4" style="display:none;"><span>Choose user type</span>
                            <table style="color: #fff;font-size:12px;" class="mt-2">
                                <tr>
                                    <!--<td><input type="radio" value="3" name="user_type"></td>-->
                                    <!--<td>&nbsp;&nbsp;</td>-->
                                    <!--<td>Buyer</td>-->
                                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                                    <td><input type="radio" value="2" name="user_type" checked></td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td>Seller</td>
                                    <!--<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>-->
                        ...
                        <div class="form-group text-start mb-4"><span>Country/Region</span>
...
// 		return false;
	...
	$('#store_name').keyup(function(e){
        ...
        $.ajax({
            'url':"{{ url('m/checkSupplierStoreName') }}",
            'type':'post',
            'dataType':'text',
            data: {store_name: store_name},
            success:function(data){
            	if (data == 'success') {
            		$('#store_section').empty().append('<p style="color:#00008B">Valid Store Name</p>') ;
            	}else{
            ...
            success:function(data){
            	if (data == "success") {
            		toastr.success('Registration Successfully Completed.', 'Please Check Your Email And Verify', { positionClass: 'toast-top-center', });
          			function explode(){
          			    if(user_type == 2){
          			        url = "<?php echo env('APP_URL'); ?>package";
          			    }else{
