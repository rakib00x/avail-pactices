...
@endphp
        ...
        <div class="container" style="margin-top:30px;">
            ...
            <div class="row g-3" id="get_data" style="margin-bottom:20px;">
...
@section('js')
    ...
    <script>
        $("#pricefilter").change(function(){
            ...
            $.ajax({
             url:"<?php echo env('APP_URL').'m/'.strtolower($supplier_info->storeName).'/getsuppliersecondarycategryfilter'; ?>",
             method:"POST",
         ...
         $(document).ready(function(){
           ...
           function loadData(limit, start)
           {
            ...
            $.ajax({
             url:"<?php echo env('APP_URL').'m/'.strtolower($supplier_info->storeName).'/getmoiblesuppliersecondarycategoryproductpanigate'; ?>",
             method:"POST",
