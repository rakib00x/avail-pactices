        ...
        <div class="card top-product-card">
            <div class="card-body mb-0 pb-0 mt-0 pt-3">
                <a class="product-thumbnail d-block single-product-recommended" href="#">
                    <img class="mb-2" src="<?php echo $base_url."public/images/".$just_for_image[0]; ?>" alt="{{ $justvalue->proudct_name }}" style="width: 155px;height: 155px;">
                </a>
                <a style="height: 30px;" class="product-title d-block" href="{{ URL::to('product/'.$justvalue->slug) }}"><?php echo Str::limit($justvalue->product_name, 20); ?></a>
                <?php
