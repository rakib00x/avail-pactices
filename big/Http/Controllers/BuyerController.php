...
class BuyerController extends Controller{
   ...
   public function sellerDashboard(){
    ...
    public function buyerAccountSetting(){
    ...
    public function buyerOrderDetails($invoice)
    {
        $result = DB::table('order_product')
            ...
            ->where('order_product.customer_id', Session::get('buyer_id'))
    ...
    public function buyerShippingAddress(){

        $result  = DB::table('express')->where('express.id', Session::get('buyer_id'))
   ...
   //update
    public function buyerShippingAddressUpdate(Request $request){
    ...
    public function updateBuyerGeneralInfo(Request $request){
    ...
    public function buyerPasswordChange(Request $request)
    {
    ...
    public function updateBuyerBasicInfo(Request $request)
    {
    ...
    public function buyerQuotationlist()
    {   
        $data               = array() ;
        $data['status']     = 1 ;
    ...
    public function geBuyertQuotationDetails(Request $request)
    {
    ...
    public function buyerSendQuotationReply(Request $request)
    {
        $quation_id = $request->quation_id;
